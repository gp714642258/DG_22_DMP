...
object TagUtils {
  ...
  def getAllUserId(row:Row):List[String]={
    ...
    if (StringUtils.isNotBlank(row.getAs[String]("openudid")))list :+="OP:" +row.getAs[String]("openudid")
    ...
    if (StringUtils.isNotBlank(row.getAs[String]("openudidmd5")))list :+="OPM:" +row.getAs[String]("openudidmd5")
    ...
    if (StringUtils.isNotBlank(row.getAs[String]("openudidsha1")))list :+="OPS:" +row.getAs[String]("openudidsha1")
